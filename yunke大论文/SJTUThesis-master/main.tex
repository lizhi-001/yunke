...
\input{contents/chapter2_1_var_foundation}
\input{contents/chapter2_2_highdim_estimation}
\input{contents/chapter2_3_hypothesis_lr_bootstrap}
\input{contents/chapter3_method}
\input{contents/chapter3_verification}
