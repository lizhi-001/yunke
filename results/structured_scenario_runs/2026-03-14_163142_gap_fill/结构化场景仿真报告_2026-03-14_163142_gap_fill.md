...
|---|---|---|---:|---:|---:|---:|
| 第一层 | baseline_ols_f | uniform | 1.00 | 1.0000 | 0.0000 | 1 |
| 第一层 | baseline_ols | uniform | 1.00 | 1.0000 | 0.0000 | 1 |
| 第二层 | sparse_lasso | sparse | 1.00 | 0.9500 | 0.0000 | 1 |

## 3. 结论摘要

- **baseline_ols_f** [普通多元时间序列 F 检验基准]: power@δ=1.00=1.0000; power单调=✗
- **baseline_ols** [LR+Bootstrap（与 F 检验对比）]: power@δ=1.00=1.0000; power单调=✗
- **sparse_lasso** [高维稀疏 LR+Bootstrap]: power@δ=1.00=0.9500; power单调=✗
