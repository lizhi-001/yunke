...
- 生成时间: 2026-03-07 23:56:24
- 方案配置: M=1, B=1, alpha=0.05, Frobenius targets=(0.1,)
- 断点构造: 沿归一化全1方向施加扰动，并固定目标 `||Phi2-Phi1||_F`；若不平稳则仅缩小扰动幅度。

- 总耗时(秒): 0.06
- 进度日志: results/large_scale_runs/2026-03-07_235624_single_progress_smoke_v2/00_progress.log
- 输出目录: results/large_scale_runs/2026-03-07_235624_single_progress_smoke_v2
...
| lowrank_svd | 1.0000 | +0.9500 | 1 | 1 | 0.01 |
...
- lowrank_svd: type1_error=1.0000; power_at_max_target_fro(0.10)=0.0000; power_gain_over_size=-1.0000; power_monotone=False
