...
| sparse_lasso | 6 | 0.0833 | 0.0833 | +0.0333 | 2 |
| lowrank_svd | 4 | 0.5000 | 0.0000 | +0.4500 | 2 |
| lowrank_svd | 6 | 0.3333 | 0.1667 | +0.2833 | 2 |

## 2. Power（固定 M_max，跨 seed 聚合）

| 模型 | M | Base δ | Target `||ΔΦ||_F` Mean | Power Mean | Power Std | Seeds |
|---|---:|---:|---:|---:|---:|---:|
| baseline_ols | 6 | 0.04 | 0.08 | 0.1667 | 0.1667 | 2 |
| baseline_ols | 6 | 0.08 | 0.16 | 0.1667 | 0.1667 | 2 |
| sparse_lasso | 6 | 0.04 | 0.20 | 0.1667 | 0.1667 | 2 |
| sparse_lasso | 6 | 0.08 | 0.40 | 0.2500 | 0.0833 | 2 |
| lowrank_svd | 6 | 0.04 | 0.40 | 0.3333 | 0.0000 | 2 |
| lowrank_svd | 6 | 0.08 | 0.80 | 0.9167 | 0.0833 | 2 |
...
- sparse_lasso: size_at_Mmax=0.0833; power_at_Mmax_and_max_delta(base_delta=0.08; target_fro_mean=0.40)=0.2500; power_gain_over_size=0.1667; power_monotone=True
- lowrank_svd: size_at_Mmax=0.3333; power_at_Mmax_and_max_delta(base_delta=0.08; target_fro_mean=0.80)=0.9167; power_gain_over_size=0.5833; power_monotone=True
